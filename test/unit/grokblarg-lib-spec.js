...
describe('grokblarg-lib', function () {
  ...
  it('should throw error when parseTableOfContents finds missing metadata "title"', function () {
    ...
    let boundParseTableOfContents = gbLib.parseTableOfContents.bind(null, toc, newFileName, metadata)
  ...
  it('should tocEntriesNewestToOldest()', function () {
    let mockToc = [
      {title: 'title2', updated: '01Jan2016', keywords: ['test', 'date', 'sort', 'entry2']},
      {title: 'title3', updated: '31Dec2015', keywords: ['test', 'date', 'sort', 'entry3']},
      {title: 'title1', updated: '20Oct2017', keywords: ['test', 'date', 'sort', 'entry1']}
    ]

    mockToc.sort(gbLib.tocEntriesNewestToOldest)
    expect(mockToc[0]).toEqual({title: 'title1', updated: '20Oct2017', keywords: ['test', 'date', 'sort', 'entry1']})
    expect(mockToc[1]).toEqual({title: 'title2', updated: '01Jan2016', keywords: ['test', 'date', 'sort', 'entry2']})
    expect(mockToc[2]).toEqual({title: 'title3', updated: '31Dec2015', keywords: ['test', 'date', 'sort', 'entry3']})
  })
